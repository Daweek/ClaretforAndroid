...
static char *Ptxdata = 
    ...
    "\n"
    "	//-----------------------------------------------------------\n"
    "	// Compiling /tmp/tmpxft_00006cac_00000000-9_mr3_opt.cpp3.i (/tmp/ccBI#.ICMc28)\n"
    "	//-----------------------------------------------------------\n"
    "\n"
    "	//-----------------------------------------------------------\n"
    "	// Options:\n"
    ...
    "	.file	3	\"/tmp/tmpxft_00006cac_00000000-8_mr3_opt.cudafe2.gpu\"\n"
    "	.file	4	\"mr3_opt.cu\"\n"
    ...
    "\n"
    "\n"
    "	.entry update_coor_kernel (\n"
    "		.param .s32 __cudaparm_update_coor_kernel_n3,\n"
    "		.param .u32 __cudaparm_update_coor_kernel_vl,\n"
    "		.param .u32 __cudaparm_update_coor_kernel_cd,\n"
    "		.param .u32 __cudaparm_update_coor_kernel_xs,\n"
    "		.param .u32 __cudaparm_update_coor_kernel_fc,\n"
    "		.param .u32 __cudaparm_update_coor_kernel_side)\n"
    "	{\n"
    "	.reg .u16 %rh<4>;\n"
    "	.reg .u32 %r<33>;\n"
    "	.reg .f32 %f<17>;\n"
    "	.reg .pred %p<7>;\n"
    "	.loc	4	56	0\n"
    "$LDWbegin_update_coor_kernel:\n"
    "	mov.u16 	%rh1, %ctaid.x;\n"
    "	mov.u16 	%rh2, %ntid.x;\n"
    "	mul.wide.u16 	%r1, %rh1, %rh2;\n"
    "	cvt.u32.u16 	%r2, %tid.x;\n"
    "	add.u32 	%r3, %r2, %r1;\n"
    "	ld.param.s32 	%r4, [__cudaparm_update_coor_kernel_n3];\n"
    "	setp.le.s32 	%p1, %r4, %r3;\n"
    "	@%p1 bra 	$Lt_0_2562;\n"
    "	.loc	4	61	0\n"
    "	ld.param.u32 	%r5, [__cudaparm_update_coor_kernel_xs];\n"
    "	ld.global.f32 	%f1, [%r5+0];\n"
    "	mul.lo.u32 	%r6, %r3, 4;\n"
    "	ld.param.u32 	%r7, [__cudaparm_update_coor_kernel_vl];\n"
    "	add.u32 	%r8, %r7, %r6;\n"
    "	ld.param.u32 	%r9, [__cudaparm_update_coor_kernel_fc];\n"
    "	add.u32 	%r10, %r9, %r6;\n"
    ...
    "	ld.param.u32 	%r27, [__cudaparm_update_coor_kernel_cd];\n"
    "	add.u32 	%r28, %r27, %r25;\n"
    "	add.u32 	%r29, %r26, %r28;\n"
    ...
    "	@%p4 bra 	$L_0_2306;\n"
    "	ld.param.u32 	%r30, [__cudaparm_update_coor_kernel_side];\n"
    "	add.u32 	%r31, %r30, %r26;\n"
    ...
    "	ld.param.u32 	%r122, [__cudaparm_nacl_kernel_if2_fvec];\n"
    ...
    "	} // nacl_kernel_if2\n"
    "\n"
    "	.entry rem_offset_kernell (\n"
    "		.param .s32 __cudaparm_rem_offset_kernell_n3,\n"
    "		.param .u32 __cudaparm_rem_offset_kernell_force)\n"
    "	{\n"
    "	.reg .u16 %rh<4>;\n"
    "	.reg .u32 %r<18>;\n"
    "	.reg .f32 %f<15>;\n"
    ...
    "	.loc	4	205	0\n"
    "	mov.f32 	%f3, 0f00000000;     	// 0\n"
    "	ld.param.s32 	%r1, [__cudaparm_rem_offset_kernell_n3];\n"
    ...
    "	ld.param.u32 	%r12, [__cudaparm_rem_offset_kernell_force];\n"
    "	add.u32 	%r13, %r12, %r11;\n"
    ...
    "	ld.param.u32 	%r15, [__cudaparm_rem_offset_kernell_force];\n"
    "	add.u32 	%r16, %r15, %r14;\n"
    ...
    "	.loc	4	222	0\n"
    "	exit;\n"
    "$LDWend_rem_offset_kernell:\n"
    "	} // rem_offset_kernell\n"
    "\n"
    "	.entry velforce_kernel (\n"
    "		.param .s32 __cudaparm_velforce_kernel_n3,\n"
    "		.param .u32 __cudaparm_velforce_kernel_fc,\n"
    "		.param .u32 __cudaparm_velforce_kernel_a_mass,\n"
    "		.param .u32 __cudaparm_velforce_kernel_vl,\n"
    "		.param .u32 __cudaparm_velforce_kernel_atype,\n"
    "		.param .u32 __cudaparm_velforce_kernel_atype_mat,\n"
    "		.param .f32 __cudaparm_velforce_kernel_hsq,\n"
    "		.param .u32 __cudaparm_velforce_kernel_ekin1)\n"
    "	{\n"
    "	.reg .u32 %r<67>;\n"
    "	.reg .f32 %f<19>;\n"
    "	.reg .pred %p<10>;\n"
    ...
    "	.loc	4	227	0\n"
    "$LDWbegin_velforce_kernel:\n"
    "	cvt.u32.u16 	%r1, %ntid.x;\n"
    "	cvt.u32.u16 	%r2, %ctaid.x;\n"
    "	mul.lo.u32 	%r3, %r1, %r2;\n"
    "	cvt.u32.u16 	%r4, %tid.x;\n"
    "	add.u32 	%r5, %r4, %r3;\n"
    "	ld.param.s32 	%r6, [__cudaparm_velforce_kernel_n3];\n"
    "	setp.le.s32 	%p1, %r6, %r5;\n"
    "	@%p1 bra 	$Lt_3_4354;\n"
    "	.loc	4	236	0\n"
    "	mul.lo.u32 	%r7, %r5, 4;\n"
    "	ld.param.u32 	%r8, [__cudaparm_velforce_kernel_fc];\n"
    "	add.u32 	%r9, %r8, %r7;\n"
    "	ld.global.f32 	%f1, [%r9+0];\n"
    "	ld.param.f32 	%f2, [__cudaparm_velforce_kernel_hsq];\n"
    "	ld.param.u32 	%r10, [__cudaparm_velforce_kernel_a_mass];\n"
    "	ld.param.u32 	%r11, [__cudaparm_velforce_kernel_atype_mat];\n"
    "	ld.param.u32 	%r12, [__cudaparm_velforce_kernel_atype];\n"
    ...
    "	ld.param.u32 	%r34, [__cudaparm_velforce_kernel_vl];\n"
    "	add.u32 	%r35, %r34, %r33;\n"
    "	ld.global.f32 	%f6, [%r35+4];\n"
    "	ld.global.f32 	%f7, [%r35+0];\n"
    "	ld.global.f32 	%f8, [%r35+8];\n"
    "	ld.param.u32 	%r36, [__cudaparm_velforce_kernel_a_mass];\n"
    "	ld.param.u32 	%r37, [__cudaparm_velforce_kernel_atype_mat];\n"
    "	ld.param.u32 	%r38, [__cudaparm_velforce_kernel_atype];\n"
    ...
    "	ld.param.u32 	%r63, [__cudaparm_velforce_kernel_ekin1];\n"
    ...
    "	.loc	4	261	0\n"
    "	exit;\n"
    "$LDWend_velforce_kernel:\n"
    "	} // velforce_kernel\n"
    "\n"
    "	.entry serie_kernel (\n"
    "		.param .u32 __cudaparm_serie_kernel_ekin,\n"
    "		.param .u32 __cudaparm_serie_kernel_mtemp,\n"
    "		.param .u32 __cudaparm_serie_kernel_mpres,\n"
    "		.param .u32 __cudaparm_serie_kernel_xs,\n"
    "		.param .f32 __cudaparm_serie_kernel_tscale,\n"
    "		.param .f32 __cudaparm_serie_kernel_nden,\n"
    "		.param .f32 __cudaparm_serie_kernel_vir,\n"
    "		.param .s32 __cudaparm_serie_kernel_s_num,\n"
    "		.param .s32 __cudaparm_serie_kernel_w_num,\n"
    "		.param .f32 __cudaparm_serie_kernel_rtemp,\n"
    "		.param .f32 __cudaparm_serie_kernel_lq,\n"
    "		.param .f32 __cudaparm_serie_kernel_hsq,\n"
    "		.param .u32 __cudaparm_serie_kernel_ekin1a,\n"
    "		.param .s32 __cudaparm_serie_kernel_limi)\n"
    "	{\n"
    "	.reg .u32 %r<17>;\n"
    "	.reg .f32 %f<25>;\n"
    "	.reg .pred %p<4>;\n"
    "	.loc	4	267	0\n"
    "$LDWbegin_serie_kernel:\n"
    "	.loc	4	269	0\n"
    "	ld.param.u32 	%r1, [__cudaparm_serie_kernel_xs];\n"
    "	ld.global.f32 	%f1, [%r1+0];\n"
    "	ld.param.s32 	%r2, [__cudaparm_serie_kernel_limi];\n"
    "	mov.u32 	%r3, 0;\n"
    ...
    "	mov.s32 	%r4, %r2;\n"
    "	mul.lo.u32 	%r5, %r2, 4;\n"
    "	ld.param.u32 	%r6, [__cudaparm_serie_kernel_ekin1a];\n"
    "	mov.s32 	%r7, %r6;\n"
    "	add.u32 	%r8, %r5, %r6;\n"
    "	mov.f32 	%f2, 0f00000000;     	// 0\n"
    "	mov.s32 	%r9, %r4;\n"
    ...
    "$Lt_4_1282:\n"
    "	.loc	4	273	0\n"
    "	ld.param.f32 	%f4, [__cudaparm_serie_kernel_hsq];\n"
    "	div.full.f32 	%f5, %f2, %f4;\n"
    "	ld.param.u32 	%r10, [__cudaparm_serie_kernel_ekin];\n"
    "	st.global.f32 	[%r10+0], %f5;\n"
    "	.loc	4	274	0\n"
    "	ld.param.u32 	%r11, [__cudaparm_serie_kernel_mtemp];\n"
    "	ld.param.f32 	%f6, [__cudaparm_serie_kernel_tscale];\n"
    "	mul.f32 	%f7, %f6, %f5;\n"
    "	st.global.f32 	[%r11+0], %f7;\n"
    "	.loc	4	275	0\n"
    "	ld.param.f32 	%f8, [__cudaparm_serie_kernel_nden];\n"
    "	mov.f32 	%f9, 0f40400000;     	// 3\n"
    "	div.full.f32 	%f10, %f8, %f9;\n"
    "	ld.global.f32 	%f11, [%r10+0];\n"
    "	ld.param.f32 	%f12, [__cudaparm_serie_kernel_vir];\n"
    "	sub.f32 	%f13, %f11, %f12;\n"
    "	mul.f32 	%f14, %f10, %f13;\n"
    "	ld.param.s32 	%r12, [__cudaparm_serie_kernel_s_num];\n"
    "	ld.param.s32 	%r13, [__cudaparm_serie_kernel_w_num];\n"
    "	add.s32 	%r14, %r12, %r13;\n"
    "	cvt.rn.f32.s32 	%f15, %r14;\n"
    "	div.full.f32 	%f16, %f14, %f15;\n"
    "	ld.param.u32 	%r15, [__cudaparm_serie_kernel_mpres];\n"
    "	st.global.f32 	[%r15+0], %f16;\n"
    "	.loc	4	276	0\n"
    "	ld.global.f32 	%f17, [%r11+0];\n"
    "	ld.param.f32 	%f18, [__cudaparm_serie_kernel_rtemp];\n"
    "	sub.f32 	%f19, %f17, %f18;\n"
    "	ld.param.f32 	%f20, [__cudaparm_serie_kernel_lq];\n"
...
/*
 * stub for remote call to update_coor_kernel.
 */
void
...
/*
 * stub for remote call to rem_offset_kernell.
 */
void
...
/*
 * stub for remote call to serie_kernel.
 */
void
